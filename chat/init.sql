...
CREATE TABLE users (
    ...
    password BINARY(60) NOT NULL, -- In a real application, this should store hashed passwords, not plain text
    auth_secret VARCHAR(255) NOT NULL UNIQUE, -- Store 2FA secret for verification
    recovery VARCHAR(255) NOT NULL UNIQUE, -- Store 2FA recovery code
